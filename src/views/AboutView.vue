...
<template>
  <div style="padding: 24px">
    <n-h2>关于</n-h2>
    <div>
      <n-h3 prefix="bar">Kenko Drive Vue 前端
        <n-tag type='info'> 版本号 </n-tag>
      </n-h3>
      <p>Github: <n-a :href="frontendRepoUrl" target="_blank">
        {{frontendRepoUrl}}</n-a>
      </p>
      <p>Copyright (C) 2023 <n-a :href="`https://github.com/${owner}`" target="_blank">{{owner}}</n-a>
      </p>
      <p>MIT License</p>
      <p>
        <n-space>
    ...
    <div>
      <n-h3 prefix="bar">Kenko Drive SpringBoot 后端
        <n-tag type='info'> 版本号 </n-tag>
      </n-h3>
      <p>Github: <n-a :href="backendRepoUrl" target="_blank">
        {{backendRepoUrl}}</n-a>
      </p>
      <p>Copyright (C) 2023 <n-a :href="`https://github.com/${owner}`" target="_blank">{{owner}}</n-a>
      </p>
