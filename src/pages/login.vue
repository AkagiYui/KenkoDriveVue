...
const registerFormRef = useTemplateRef<FormInst>("registerFormRef")
const smsFormRef = useTemplateRef<FormInst>("smsFormRef")
const emailOtpInputRef = useTemplateRef<HTMLInputElement>("emailOtpInputRef")
const smsOtpInputRef = useTemplateRef<HTMLInputElement>("smsOtpInputRef")
